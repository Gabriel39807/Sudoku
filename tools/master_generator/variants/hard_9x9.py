"""Hard 9x9 dataset generator — 1000 levels with tramo-based technique progression."""
...
TRAMO_CONFIG = [
    {"start": 1, "end": 200, "clues": 52, "label": "Tramo 1 — Intersections",
     ...
     "tier_max": 2, "est_minutes": 5},
    {"start": 201, "end": 400, "clues": 50, "label": "Tramo 2 — Pairs",
     "tech_ids": {"last_blank_cell", "full_house", "naked_single", "hidden_single",
                  "pointing_pair", "pointing_triple", "box_line_reduction",
     ...
     "tier_max": 3, "est_minutes": 6},
    {"start": 401, "end": 650, "clues": 48, "label": "Tramo 3 — Triples",
     "tech_ids": {"last_blank_cell", "full_house", "naked_single", "hidden_single",
                  "pointing_pair", "pointing_triple", "box_line_reduction",
     ...
     "tier_max": 4, "est_minutes": 7},
    {"start": 651, "end": 850, "clues": 47, "label": "Tramo 4 — Quads",
     "tech_ids": {"last_blank_cell", "full_house", "naked_single", "hidden_single",
                  "pointing_pair", "pointing_triple", "box_line_reduction",
                  "naked_pair", "hidden_pair", "naked_triple", "hidden_triple",
    ...
    {"start": 851, "end": 1000, "clues": 46, "label": "Tramo 5 — XWing",
     "tech_ids": {"last_blank_cell", "full_house", "naked_single", "hidden_single",
                  "pointing_pair", "pointing_triple", "box_line_reduction",
                  "naked_pair", "hidden_pair", "naked_triple", "hidden_triple",
     ...
     "tier_max": 5, "est_minutes": 10},
]

FORBIDDEN_TECH_IDS = {
    "swordfish", "jellyfish", "xywing", "xyzwing",
...
class Hard9x9Generator:
    """Generates hard 9x9 puzzles with tramo-based technique limitation."""
...
def generate_hard_dataset(output_dir: str, checkpoint_path: str,
                          seed: int = 42) -> List[Dict]:
    os.makedirs(output_dir, exist_ok=True)
    gen = Hard9x9Generator(seed=seed)
