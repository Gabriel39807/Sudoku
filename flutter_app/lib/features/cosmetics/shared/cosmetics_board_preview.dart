...
class CosmeticsBoardPreview extends StatelessWidget {
  ...
  Widget _buildFrame() {
    return Stack(
      children: [
        Positioned(top: 0, left: 0, child: Image.asset(frame.corners.tl, width: _previewFrameThickness, height: _previewFrameThickness)),
        Positioned(top: 0, right: 0, child: Image.asset(frame.corners.tr, width: _previewFrameThickness, height: _previewFrameThickness)),
        Positioned(bottom: 0, left: 0, child: Image.asset(frame.corners.bl, width: _previewFrameThickness, height: _previewFrameThickness)),
        Positioned(bottom: 0, right: 0, child: Image.asset(frame.corners.br, width: _previewFrameThickness, height: _previewFrameThickness)),
